...
public class FoxLife extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fox_life);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/foxlife.m3u8");


        mediaSource.setDisplayName("Fox Life");
