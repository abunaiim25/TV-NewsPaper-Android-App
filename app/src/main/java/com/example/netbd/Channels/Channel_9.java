...
public class Channel_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/channel9.m3u8");


        mediaSource.setDisplayName("Channel 9");
