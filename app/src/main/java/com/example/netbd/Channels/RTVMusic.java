...
public class RTVMusic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rtvmusic);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/rtvmusic.m3u8");


        mediaSource.setDisplayName("RTV Music");
