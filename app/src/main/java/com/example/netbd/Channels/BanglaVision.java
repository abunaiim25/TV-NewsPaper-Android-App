...
public class BanglaVision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bangla_vision);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/banglavisiontv.m3u8");


        mediaSource.setDisplayName("Banglavision");
