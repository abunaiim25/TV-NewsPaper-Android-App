...
public class Mohona extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/mohonatv.m3u8");


        mediaSource.setDisplayName("MOHONA TV");
