...
public class ColorsBangla extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colors_bangla);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://yuppcatchup.akamaized.net/preview/etvbengali/2500.m3u8");


        mediaSource.setDisplayName("Colors Bangla");
