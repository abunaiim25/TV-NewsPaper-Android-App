...
public class Aljazeera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://live-hls-web-aje.getaj.net/AJE/01.m3u8");


        mediaSource.setDisplayName("Al Jazeera");
