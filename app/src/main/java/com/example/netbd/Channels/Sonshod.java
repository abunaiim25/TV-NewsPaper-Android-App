...
public class Sonshod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sonshod);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/sangsadtv.m3u8");


        mediaSource.setDisplayName("Sangsad TV");
