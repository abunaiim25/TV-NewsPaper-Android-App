...
public class Jamuna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jamuna);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/jamunatv.m3u8");


        mediaSource.setDisplayName("Jamuna TV");
