...
public class ATVIslamic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_t_v_islamic);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/atnislamic.m3u8");


        mediaSource.setDisplayName("ATN Islamic");
