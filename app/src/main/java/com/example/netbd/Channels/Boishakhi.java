...
public class Boishakhi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boishakhi);
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://rhridoy136.shortcm.li/boishakhitv.m3u8");


        mediaSource.setDisplayName("Boishakhi");
